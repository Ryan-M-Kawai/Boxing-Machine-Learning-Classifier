...
FEATURE_CONFIGS = {
    "punch": {
        ...
        "checkpoint": os.path.join('pytorch_models', 'punch_classifier_best.pt'),
        "encoder_file": os.path.join('pickle_models', 'label_encoder.pkl'),
        "input_size": 26,
    ...
    "sideways": {
        ...
        "data_key": "frames",
        "checkpoint": os.path.join('pytorch_models', 'punch_classifier_sideways_best.pt'),
        "encoder_file": os.path.join('pickle_models', 'label_encoder_sideways.pkl'),
        "input_size": 26,
        "model_class": PunchClassifier,
    },
    "stance": {
        ...
        "checkpoint": os.path.join('pytorch_models', 'stance_classifier_best.pt'),
        "encoder_file": os.path.join('pickle_models', 'stance_label_encoder.pkl'),
        "input_size": 10,
